...
const TelegramIcon = ({styleFill, styleStroke}: ITelegramIcon) => {
    return (
        <>
            <svg className="transition-transform transition-color duration-700 ease-in-out hover:rotate-360" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
